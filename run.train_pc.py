#!/usr/bin/env python3
"""Editable Python launcher for protein-coding RPF-input training."""
...
TRAIN_DATASET_FILES = [
    "human_tissue_22c_6k_depth0.1_cov0.1_rpm1_pc.train.h5",
    "macaque_4c_6k_depth0.1_cov0.1_rpm1_pc.train.h5",
    "mouse_3c_6k_depth0.1_cov0.1_rpm1_pc.train.h5",
]
VALID_DATASET_FILES = [
    "human_tissue_22c_6k_depth0.1_cov0.1_rpm1_pc.valid.h5",
    "macaque_4c_6k_depth0.1_cov0.1_rpm1_pc.valid.h5",
    "mouse_3c_6k_depth0.1_cov0.1_rpm1_pc.valid.h5",
]
