...
for learning_rate in 0.005 0.0001; do
    export TRACE_LEARNING_RATE="${learning_rate}"
    train_log="${PROJECT_DIR}/run.train_seq.hs_5c.alpha1_beta0.lr${learning_rate}.log"
...
train_log="${PROJECT_DIR}/run.train_seq.hs_5c.256d_12l.alpha1_beta0.lr0.001.log"
...
train_log="${PROJECT_DIR}/run.train_seq.hs_5c.256d_8h_12l.alpha1_beta0.lr0.001.log"
...
train_log="${PROJECT_DIR}/run.train_seq.hs_5c.256d_6l.alpha1_beta0.lr0.001.log"
