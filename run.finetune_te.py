...
train_paths = [
    ...
    for n in [human_t_dataset_name, human_cl_dataset_name, human_cl_un_dataset_name,
              macaque_dataset_name, mouse_dataset_name]
]
val_paths = [
...
base_model = TranslationBaseModel.from_config(
    "/home/user/data3/rbase/translation_model/TRACE/src/config/base_model_expr_384d_16h_12l_128env_32ad.yaml"
).cuda(rank)

# Load pretrained weights
ckpt_path = os.path.join(
    "/public-supool/home/annie/translation_model/checkpoint/pretrain",
    # Update this to your actual pretrained checkpoint name
    "Expr384d16h12l.hs_21c_18c_26c_rm_4c_mm_3c_6k_depth0.1_cov0.1_rpm1.400_0.001.best.pth",
)
...
base_model.add_head(
    "te",
    TERegressionHead.create_from_model(base_model, d_pred_h=128, p_drop=0.1),
    overwrite=True,
)
...
trainer = TEFinetuneTrainer(
    ...
    batch_size=32,
    checkpoint_dir="/public-supool/home/annie/translation_model/checkpoint/finetune_te",
    log_dir="/public-supool/home/annie/translation_model/log/finetune_te",
